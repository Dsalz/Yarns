...
import { addComment , resetCommentAddedAction } from '../../actions/commentActions';
...
class AddComment extends Component{
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        this.props.addComment(this.state, this.props.match.params.roomName);
        this.setState({
            submitted: true
        })
    }
...
const mapDispatchToProps = (dispatch) => {
    return {
        addComment : (comment, roomName) => dispatch(addComment(comment, roomName)),
