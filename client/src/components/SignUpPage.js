        ...
        return (isLoggedIn) ? <Redirect to="/"></Redirect> : (
            <section className="loginsection">
                ...
                <form onSubmit= {this.handleSubmit}>
                    ...
                    <input type="text" id="username" name="username" placeholder="Username" onChange = { this.handleChange } onKeyUp={ this.checkUsernameAvailability } required/>{(usernameAvailable === "loading") ? <span><img src="/images/smallLoading.gif" className="loginsection-usernamecheckingimg" alt="username loading"/></span> :(usernameAvailable === null)? <span></span> : (usernameAvailable === true)? <span><img src="/images/usernameAvailable.png" className="loginsection-usernamecheckingimg" alt="username available"/></span> : <span><img src="/images/usernameNotAvailable" className="loginsection-usernamecheckingimg" alt="username not available"/></span> }<br/>
